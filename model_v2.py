...
class set_config_v2:
    ...
    def setup(self, model):
        ...
        logging.getLogger().info(f"Model v2 setup: Using SGD optimizer with lr=0.05, momentum=0.9, StepLR scheduler with step_size=6, gamma=0.1 for {self.epochs} epochs")
    ...
    def get_dataloader_args(self):
        ...
        logging.info(f"Model v2 dataloader args: {data_loaders_args}")
